...
import {
  addObserveTarget, // 添加固钉目标对象
  getFixedBottom, // 取得应该到底部的距离
  getFixedTop, //  取得应该到顶部的距离
  getTargetRect, // 返回目标的DOMRect
  removeObserveTarget, // 移除固钉目标对象
} from './utils';
...
/** 固钉的定位由纯js代码控制，在children外包裹了两层div */
class Affix extends React.Component<InternalAffixProps, AffixState> {
  ...
  // Event handler 获取固钉目标元素，异步添加、更新固钉位置
  componentDidMount() {
  ...
  // @ts-ignore TS6133 清空固钉样式，调整固钉到准备状态
  prepareMeasure = () => {
