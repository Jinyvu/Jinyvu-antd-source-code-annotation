...
export interface CheckboxOptionType {
  label: React.ReactNode; // 选项的名称
  value: CheckboxValueType; // 选项代表的值
...
export interface CheckboxGroupContext {
  name?: string;
  toggleOption?: (option: CheckboxOptionType) => void; // 切换选项
  value?: any;
  disabled?: boolean;
