...
import collapseMotion from '../_util/motion'; // 塌陷动画
import { cloneElement } from '../_util/reactNode';
import warning from '../_util/warning';
import type { ItemType } from './hooks/useItems';
import useItems from './hooks/useItems'; // 实时将菜单项转化为对应的rc-menu项
import MenuContext, { MenuTheme } from './MenuContext'; // 菜单上下文、菜单主题
import MenuDivider from './MenuDivider'; // 菜单分割线
import Item, { MenuItemProps } from './MenuItem'; // 菜单项
import OverrideContext from './OverrideContext'; // 与rc-menu对应的上下文对象
import SubMenu, { SubMenuProps } from './SubMenu'; // 子菜单
...
/**
 * 使用overriderContext和MenuContext包裹rc-menu overriderContext提供与rc-menu有关参数 MenuContext提供自定义参数
 * 使用useItems将MenuItem/MenuDivider/SubMenu转化为对应的rc-menu组件
 */
...
/** 使用SiderContext包裹，使得菜单可以与侧边栏共用一些属性，主要是菜单折叠相关 */
